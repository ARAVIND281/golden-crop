...
export default class SoilTest3 extends Component {
  changeScreen1 = () => {
    this.props.navigation.navigate('SoilTest4');
  };

  changeScreen2 = () => {
    this.props.navigation.navigate('SoilTest3_1');
  };
    ...
    return (
      <View style={{ backgroundColor: '#d3d3d3' }}>
        ...
        <Text style={{ marginLeft: 25, marginRight: 25, textAlign: 'justify' }}>
          ...
          well and then leave to settle for 12 hours.Does your soil leave cloudy
          water with a layer of particles at the bottom.Does your soil feel soft
          and soapy,does it hold moisture.
        </Text>
