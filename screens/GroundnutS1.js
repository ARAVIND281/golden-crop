...
export default class GroundnutS1 extends Component {
  changeScreen1 = () => {
    this.props.navigation.navigate('GroundnutS2');
  };

  changeScreen2 = () => {
    this.props.navigation.navigate('GroundnutS1_1');
  };
    ...
    return (
      <View style={styles.background}>
        ...
        <Text style={styles.bodyText}>
          Chlorotic spots appear on young leaflets and necrotic rings and
          streaks are developed. The virus is mainly transmitted by thrips.
        </Text>
        <form>
