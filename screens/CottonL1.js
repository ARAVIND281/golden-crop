...
export default class CottonL1 extends Component {
  changeScreen1 = () => {
    this.props.navigation.navigate('CottonL2');
  };

  changeScreen2 = () => {
    this.props.navigation.navigate('CottonL1_1');
  };
    ...
    return (
      <ScrollView style={styles.background}>
        ...
        <Text style={styles.bodyText}>
          Do you find Black lesions on stem and branches or premature drooping
          off of the leaves resulting in die back known as Black arm.It also
          affects the bolls causing boll rot.
        </Text>
