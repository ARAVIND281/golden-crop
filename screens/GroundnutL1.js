...
export default class GroundnutL1 extends Component {
  changeScreen1 = () => {
    this.props.navigation.navigate('GroundnutL2');
  };

  changeScreen2 = () => {
    this.props.navigation.navigate('GroundnutL1_1');
  };
    ...
    return (
      <View style={styles.background}>
        ...
        <Text style={styles.bodyText}>
          you find Small chlorotic spots on leaflets, with time they enlarge and
          turn brown to black and assume sub circular shape on upper leaf
          surface.On lower surface of leaves light brown colouration is seen.
