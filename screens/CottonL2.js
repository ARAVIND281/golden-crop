...
export default class CottonL2 extends Component {
  changeScreen1 = () => {
    this.props.navigation.navigate('CropTreatmentNo');
  };

  changeScreen2 = () => {
    this.props.navigation.navigate('CottonL2_1');
  };
    ...
    return (
      <View style={styles.background}>
        ...
        <Text style={styles.bodyText}>
          Is there any Small, irregular or round spots, on the leaves.If Each
          spot has a central lesion surrounded by concentric rings.The affected
          leaves become brittle and fall off.Sometimes stem lesions are also
          seen.
        </Text>
        <form>
